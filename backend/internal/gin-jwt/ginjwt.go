...
//This is a sligtly modofied version of https://github.com/appleboy/gin-jwt
//LoginResponse has been modified to take an interface
...
func (mw *GinJWTMiddleware) MiddlewareInit() error {
	...
	if mw.LoginResponse == nil {
		mw.LoginResponse = func(c *gin.Context, code int, token string, expire time.Time, data interface{}) {
...
func (mw *GinJWTMiddleware) LoginHandler(c *gin.Context) {
	...
	mw.LoginResponse(c, http.StatusOK, tokenString, expire, data)
}
